...
import type { PlaybackPrediction, VideoSite, VideoStatePayload } from "../shared/types";
...
export function gatherVideoState(video: HTMLVideoElement | null): VideoStatePayload | null {
...
function recordPlaybackSample(snapshot: VideoStatePayload | null) {
  if (!snapshot) {
    return;
  }
