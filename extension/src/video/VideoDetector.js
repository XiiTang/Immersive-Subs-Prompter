...
import { ensureDocListeners, scanForShadowRoots } from "../monitoring/DOMObserver.js";
import { ensureDriftMonitor, stopDriftMonitor } from "../monitoring/DriftMonitor.js";
...
export function handleDocumentMediaEvent(event) {
  if (!state.monitoringActive) {
    return;
  }
