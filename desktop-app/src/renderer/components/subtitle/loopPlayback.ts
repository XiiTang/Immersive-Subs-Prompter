...
export function getLoopWindow(loop: LoopSession | null): LoopWindow | null {
...
export function getSingleLoopCueIndex(loop: LoopSession | null): number | null {
  if (loop?.mode !== "single") {
    return null;
  }
...
export function getLoopWrapCueIndex(loop: LoopSession | null): number | null {
