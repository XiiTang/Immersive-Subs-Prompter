...
export class AppEventBus extends EventEmitter {
  ...
  on<K extends AppEvent>(event: K, listener: Listener<K>): this {
    return super.on(event, listener);
  }

  once<K extends AppEvent>(event: K, listener: Listener<K>): this {
    return super.once(event, listener);
  }

  off<K extends AppEvent>(event: K, listener: Listener<K>): this {
